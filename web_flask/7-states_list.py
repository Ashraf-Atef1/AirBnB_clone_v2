...
get_data("cp -f ./main_0.py ./main_1.py")
get_data("cp -f ./main_0.py ./main_2.py")
get_data("cp -f ./main_0.py ./main_3.py")
get_data("cp -f ./main_0.sql ./main_1.sql")
get_data("cp -f ./main_0.sql ./main_2.sql")
get_data("cp -f ./main_0.sql ./main_3.sql")
